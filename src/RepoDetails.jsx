...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/AdeTiDotun/${id}`, {
      // headers: {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/AdeTiDotun/${id}/branches`, {
      // headers: {
      //   Authorization: `token ${import.meta.env.VITE_REACT_APP_GITHUB_TOKEN}`
      // },
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/AdeTiDotun/${id}/deployments`, {
      // headers: {
      //   Authorization: `token ${import.meta.env.VITE_REACT_APP_GITHUB_TOKEN}`
      // },
    })
  ...
  return (
    <div id="repodetail">
        <div className="repodetail-card">
            ...
            <p>Live site: {deployment.length === 0 ? `none` : <a href={`https://AdeTiDotun.github.io/${details.name}`}>AdeTiDotun.github.io/{details.name}</a>}</p>
